...
check.addEventListener("click", () => {
    ...
    let url = `http://api.openweathermap.org/data/2.5/weather?q=${city.value},${country.value}&lang=en&units=imperial&appid=${key}`;
    ...
    fetch(url).then(response => {
        ...
        temperature.innerHTML = `${data.main.temp}°<b>F</b>`;
